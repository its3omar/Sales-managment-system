...
{
    public partial class ValuedCustomerForm : Form
    {
        CustomerService _customerService;
        public ValuedCustomerForm(CustomerService customerService)
        {
            InitializeComponent();
            _customerService=customerService;
            dataGridView1.DataSource = _customerService.GetValuedCustomers();
